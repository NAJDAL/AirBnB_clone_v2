#!/usr/bin/python3
# Description: Fabfile to package and deploy web_static content to a web server.
...
def do_pack():
    ...
    Returns:
        str: Path to the generated .tgz archive if successful, else None.
    """
    dt = datetime.utcnow()
...
def deploy():
    """
    Package and deploy web_static content to a web server.
